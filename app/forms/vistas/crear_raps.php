...
function cargarComparacion() {
    ...
    console.log('Debug - Código competencia completo:', codigoCompetencia);
    ...
    if (!codigoCompetenciaReal || partes.length < 3) {
        document.getElementById('comparacionContent').innerHTML = `
            <div class="alert alert-danger">
                <i class="fas fa-exclamation-triangle"></i>
                <strong>Error:</strong> No se pudo extraer el código de competencia.
                <br><small>Código recibido: ${codigoCompetencia}</small>
            </div>
        `;
        return;
    }
    ...
    document.getElementById('comparacionContent').innerHTML = `
        <div class="alert alert-info">
            <i class="fas fa-spinner fa-spin"></i> Cargando comparación...
        </div>
    `;
