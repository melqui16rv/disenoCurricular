...
<?php else: ?>
    ...
    <form method="POST" id="formCompletarCompetencia">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group <?php echo empty($competencia_actual['codigoCompetencia']) ? 'campo-faltante' : ''; ?>">
                    <label for="codigoCompetencia">
                        <i class="fas fa-hashtag"></i> Código de la Competencia
                        <?php if (empty($competencia_actual['codigoCompetencia'])): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!codigoCompetencia) {
            e.preventDefault();
            alert('Por favor, ingrese el código de la competencia.');
            return;
        }
